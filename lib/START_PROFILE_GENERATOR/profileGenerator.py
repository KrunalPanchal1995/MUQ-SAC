...
if flameis == "UnstretchedPremixed":
	if ExpTempFile == "":
		exp = "Fls"
		...
		exp = "Flf"
		expType = "HeatFlux"
	inputs["exp_type"] = {"exp":exp,"type":expType}
...
inputs["startProfileLoc"] = startProfileLoc
shutil.copy(startProfileLoc,inputs["CopyTo"])
shutil.copy(startProfileLoc,inputs["MechanismFile"])
