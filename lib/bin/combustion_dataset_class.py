...
class combustion_dataset():
	def __init__(self,set_name,Target_Dataset,optimized_params):
		...
		for Target_object in Target_Dataset:
			...
			self.opt_target_values.append((Target_object["Target_database"].calculated_target_value(self.opt_params))*1000.0)
			...
			self.Unsrt_fct.append(np.abs(Target_object["Target_database"].std_dvtn)*1000)
			...
			self.observed.append((Target_object["Target_database"].observed)*1000.0)
