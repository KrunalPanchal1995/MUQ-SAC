...
unsrt_data,rxnUnsrt_data,plog_data,interconnectedrxn,focUnsrt_data,tbdUnsrt_data,thermoUnsrt_data,transportUnsrt_data, reaction_index,plog_rxn_list,interconnectedlist,fallOffCurve_index, thirdBody_index, thermo_index, transport_index = UncertDataSet.extract_uncertainty();
