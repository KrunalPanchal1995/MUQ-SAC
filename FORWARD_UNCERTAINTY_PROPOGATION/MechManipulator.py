...
class Manipulator:
	def __init__(self,copy_of_mech,unsrt_object,perturbation,perturbation_type = "opt",rxn_dict = None):
		#self.mechanism = copy_of_mech
		self.mechanism = deepcopy(copy_of_mech)
		self.unsrt = unsrt_object
		self.perturbation_type = perturbation_type
		if perturbation_type != "SA":
			self.rxn_type = rxn_dict["type"]
			self.rxn_data = rxn_dict["data"]
			self.rxn_dict = rxn_dict["reaction"]
			self.rxn_list = [rxn_dict["reaction"][index] for index in rxn_dict["reaction"]]
		else:
			self.rxn_type = unsrt_object["type"]
			self.rxn_data = unsrt_object["data"]
			self.rxn_dict = unsrt_object["reaction"]
			self.rxn_list = [unsrt_object["reaction"][index] for index in unsrt_object["reaction"]]
