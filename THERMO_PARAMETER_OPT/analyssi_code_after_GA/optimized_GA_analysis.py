# this code uses the unsrt.pkl file to find out the nominal param,s and cov matrices of the species paramameters.. Takes the optimized GA iteration (zeta) and calculates the params-- P0+ L zeta
import os
import pickle
import numpy as np
