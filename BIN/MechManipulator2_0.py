...
class Manipulator:
	...
	def ElementaryPerturbation(self,rxn,beta,selection,mechanism):
		...
		mechanism["reactions"][index]["rate-constant"] = reaction_details
	...
	def PlogPerturbation(self,rxn,beta,selection,mechanism):
		...
		reaction_details["Ea"] = float(p[2]*1.987)
		#print(reaction_details)
		mechanism["reactions"][index]["rate-constants"][pressure_index] = reaction_details
	...
	def TroePerturbation(self,rxn,beta,selection,mechanism):
		...
		reaction_details["Ea"] = float(p[2]*1.987)
		if P_limit == "High":
			mechanism["reactions"][index]["low-P-rate-constant"] = reaction_details
		else:
			mechanism["reactions"][index]["low-P-rate-constant"] = reaction_details
		return mechanism
